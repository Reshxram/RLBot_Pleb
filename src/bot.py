...
if __name__ == '__main__':  # Required for multiprocessing
    ...
    env = VecNormalize(env, norm_obs=False, gamma=gamma)  # Normalizes rewards
    ...
    try:
        ...
        model = PPO(
            ...
            learning_rate=5e-5,  # Common for PPO
            ...
            tensorboard_log="links",  # `tensorboard --logdir out/links` in terminal to see graphs
